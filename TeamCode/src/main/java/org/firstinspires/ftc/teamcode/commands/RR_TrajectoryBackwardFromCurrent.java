...
public class RR_TrajectoryBackwardFromCurrent extends CommandBase {
    MecanumDriveSubsystem m_drivetrain;
    double m_distance;
    boolean m_reversed;
    public RR_TrajectoryBackwardFromCurrent(MecanumDriveSubsystem p_drivetrain, double p_distance,
                                            boolean p_reversed){
