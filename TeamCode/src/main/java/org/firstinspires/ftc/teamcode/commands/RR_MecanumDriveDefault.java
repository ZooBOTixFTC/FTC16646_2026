...
public class RR_MecanumDriveDefault extends CommandBase {
    ...
    SUB_Drivetrain m_drivetrain = null;
    private GamepadEx m_driverOP = null;
    private double m_driverOffsetAngle = 0;
    private double m_joystickMin = 0.02;
    public RR_MecanumDriveDefault(SUB_Drivetrain p_drive, GamepadEx p_driverOP, double driverOffsetAngle,
          double joystickMin) {
        m_drivetrain = p_drive;
        m_driverOP = p_driverOP; // gamepad of driver
