...
public class CMD_Shoot extends SequentialCommandGroup {
    public CMD_Shoot(MecanumDriveSubsystem p_drive, SUB_ShooterLeft p_shooterLeft, SUB_ShooterRight p_shooterRight,
                     SUB_Lift p_lift, SUB_Intake p_intake, SUB_Vision p_vision, GamepadEx p_driverOp){
        addRequirements(p_shooterLeft, p_shooterRight);
        addCommands(
