...
public class AUTO_FarRed extends Robot_Auto {
    ...
    private SequentialCommandGroup intakeFirstSpikeMark(){
        return new SequentialCommandGroup(
            ...
            ,new RR_TrajectoryLineToLinearHeading(m_robot.drivetrain, new Pose2d(-30, -54, Math.toRadians(-90)), false, DriveConstants.MAX_VEL/3)
    ...
    private SequentialCommandGroup thirdVolley(){
        return new SequentialCommandGroup(
            ...
            ,new CMD_Shoot(m_robot.m_shooter, m_robot.m_kicker, m_robot.m_intake)
            ,new InstantCommand(()-> m_robot.m_shooter.setShootingVelocity(0))
            ,new RR_TrajectoryLineToLinearHeading(m_robot.drivetrain, new Pose2d(-40, -12, Math.toRadians(0)), false, DriveConstants.MAX_VEL/2)
        );
    }
}
