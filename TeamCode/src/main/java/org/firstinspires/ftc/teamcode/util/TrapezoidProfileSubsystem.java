...
import static org.firstinspires.ftc.teamcode.util.ErrorMessages.requireNonNullParam;
...
public abstract class TrapezoidProfileSubsystem extends SubsystemBase {
    ...
    public TrapezoidProfileSubsystem(
        ...
        m_profile = new TrapezoidProfile(constraints, new TrapezoidProfile.State(0, 0));
    ...
    public void periodic() {
        m_state = m_profile.calculate(m_period);
        if (m_enabled) {
            useState(m_state);
        }
    }
