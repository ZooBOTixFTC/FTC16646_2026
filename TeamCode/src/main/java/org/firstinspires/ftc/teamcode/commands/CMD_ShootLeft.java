...
public class CMD_ShootLeft extends SequentialCommandGroup {
    public CMD_ShootLeft(SUB_Shooter p_shooter, GamepadEx m_gamepad){
        ...
        addCommands(
            ...
            new InstantCommand(()-> p_shooter.setKickLeftPower(ShooterConstants.kKickOn)),
            new CMD_WaitUntilTrue(m_gamepad,GamepadKeys.Button.LEFT_BUMPER)
        );
    }
}
